                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10 loginStyleMargin">
                                    <input id="email" type="text" placeholder="Gebruikernaam" class="Loginform-controlStyle form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
